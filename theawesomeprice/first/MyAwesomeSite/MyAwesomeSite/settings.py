"""
Django settings for MyAwesomeSite project.
...
TEMPLATE_DIR_PAGESCRAPE=os.path.join(BASE_DIR,"templates")
TEMPLATE_DIR_BLOG=os.path.join(BASE_DIR,'templates')
...
TEMPLATES = [
    {
        ...
        'DIRS': [TEMPLATE_DIR_PAGESCRAPE,TEMPLATE_DIR_BLOG],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'MyAwesomeSite.wsgi.application'
